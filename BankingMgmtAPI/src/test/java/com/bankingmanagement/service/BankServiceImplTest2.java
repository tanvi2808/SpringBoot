...
public class BankServiceImplTest2 {
    ...
    public void testFindAllWithEmptyData() throws BankNotFoundException {
    ...
    @Test
    public void testFindBankDetails() throws BankNotFoundException, InterruptedException {
        Bank bank = new Bank();
        bank.setBankCode(999);
        bank.setBankName("SBI");
        bank.setBankAddress("Mumbai");
    ...
    @Test(expected = BankNotFoundException.class)
    public void testFindBankDetailsWithInvalidInput() throws BankNotFoundException, InterruptedException {

        BankDTO bankDTO = bankService.findBankById(0);
        assertNull(bankDTO);
    }
}